...
export function DashboardSnapshot() {
  ...
  return (
    <div id="platform-demo" className="w-full relative text-left">
      <div className="absolute inset-x-8 -top-12 bottom-12 bg-gradient-to-b from-purple-100/40 via-gray-100/40 to-transparent blur-3xl rounded-[3rem] pointer-events-none -z-10"></div>
      ...
      <div className="h-10 bg-gray-50 border-b border-gray-100 flex items-center px-4 gap-2">
        ...
        <div className="mx-auto text-xs font-mono text-gray-400 pr-12">dmspilot.app/command-center</div>
      </div>
      ...
      >
        ...
        <div className="hidden lg:flex w-64 bg-gray-50/50 border-r border-gray-100 p-6 flex-col justify-between shrink-0">
          ...
          <div className="space-y-4">
            <div className="bg-orange-50 rounded-xl p-4 border border-orange-100/50 relative overflow-hidden">
              <div className="absolute -right-4 -top-4 w-16 h-16 bg-orange-200/50 rounded-full blur-xl pointer-events-none"></div>
              <div className="flex items-center gap-2 mb-2 relative z-10">
                <Briefcase className="w-4 h-4 text-orange-600" />
                <span className="text-xs font-bold text-orange-900 uppercase tracking-wider">Dealer Network</span>
              </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-white pb-8">
          ...
          <header className="h-16 px-6 sm:px-8 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white/80 backdrop-blur-md z-10">
            <div className="flex bg-gray-100/80 px-4 py-2 rounded-full items-center gap-2 w-64 border border-transparent focus-within:border-orange-200 focus-within:bg-white transition-all">
          ...
          <div className="px-6 sm:px-8 pt-8 space-y-8 flex-1">
            <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-4">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Sales Command Center</h2>
                    ...
                    <div key={i} className="w-full flex flex-col items-center gap-2 group">
                      <div className="w-full relative flex justify-center">
                        ...
                        <motion.div 
                          ...
                          className={`w-full rounded-t-md max-w-[32px] will-change-[height] ${i === 10 ? 'bg-orange-600' : 'bg-orange-100 group-hover:bg-orange-200 transition-colors'}`} style={{ height: `${h}%` }} 
                        />
                      </div>
                    </div>
                  ))}
