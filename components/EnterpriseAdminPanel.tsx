...
export function EnterpriseAdminPanel() {
  return (
    <div className="bg-[#f0f9ff] rounded-3xl md:rounded-[3rem] p-3 md:p-6 w-full border border-sky-100 font-sans text-gray-900">
      <div className="bg-white/80 backdrop-blur-xl rounded-2xl md:rounded-[2.5rem] flex flex-col border border-white">
        ...
        <div className="px-4 md:px-10 py-4 md:py-6 border-b border-sky-50 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
           <div className="flex items-center gap-4">
              <div className="w-10 h-10 bg-sky-600 rounded-xl flex shrink-0 items-center justify-center text-white font-black text-xl">
                A
              </div>
           ...
           <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full md:w-auto">
              <div className="bg-white rounded-xl px-4 py-2 flex items-center gap-3 border border-gray-100 w-full sm:w-64">
              ...
              <div className="hidden md:flex gap-4 shrink-0">
                <div className="w-10 h-10 rounded-full bg-white border border-gray-100 flex items-center justify-center text-gray-400 hover:text-sky-600 transition-colors cursor-pointer relative">
                   <Bell className="w-4 h-4" />
                   <span className="absolute top-0 right-0 w-2.5 h-2.5 bg-rose-500 border-2 border-white rounded-full"></span>
                </div>
                <div className="w-10 h-10 rounded-full bg-white border border-gray-100 flex items-center justify-center text-gray-400 hover:text-sky-600 transition-colors cursor-pointer">
        ...
        <div className="p-4 md:p-8 flex-1 flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
              {[
                ...
                <div key={i} className="bg-white p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-[1.5rem] md:rounded-[2rem] border border-gray-100 flex flex-col justify-between group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-gray-950 p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-[1.5rem] md:rounded-[2rem] border border-gray-800 relative overflow-hidden">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-[1.5rem] md:rounded-[2rem] border border-gray-100 flex flex-col">
          ...
          <div className="w-full lg:w-72 shrink-0 space-y-4 sm:space-y-6">
             <div className="bg-sky-600 rounded-xl sm:rounded-[1.5rem] md:rounded-[2rem] p-4 sm:p-5 md:p-6 text-white relative overflow-hidden group">
               ...
               <button className="w-full py-3 bg-white text-sky-900 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-sky-50 transition-colors">
                 Execute Re-Route
               </button>
             </div>

             <div className="bg-white rounded-xl sm:rounded-[1.5rem] md:rounded-[2rem] p-4 sm:p-5 md:p-6 border border-gray-100">
