...
import { ArrowRight, ArrowUpRight, ShieldCheck, CheckCircle2, Lock } from 'lucide-react';
  ...
  return (
    <footer className="bg-slate-50/70 text-slate-600 pt-16 pb-12 border-t border-slate-200 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 p-6 sm:p-10 mb-16 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-200/80 text-blue-700 text-xs font-bold uppercase tracking-wider mb-3">
              <ShieldCheck className="w-3.5 h-3.5" />
              <span>Enterprise Grade Dealership OS</span>
            </div>
            <h3 className="text-xl sm:text-2xl font-black text-slate-950 tracking-tight leading-snug">
              Unify your rooftops on one cloud-native platform
            </h3>
            <p className="mt-2 text-sm text-slate-500 font-normal leading-relaxed">
              Eliminate batch sync delays, fragmented desking calculators, and siloed DMS data pipelines.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto shrink-0">
            <Link href="/contact-us" className="w-full sm:w-auto">
              <button 
                type="button"
                className="relative group overflow-hidden w-full sm:w-auto h-11 px-7 rounded-full bg-white text-slate-950 text-sm font-bold border-2 border-slate-950 flex items-center justify-center gap-2 transition-all duration-300"
              >
                ...
                <ArrowRight className="relative z-10 w-3.5 h-3.5 transition-transform duration-300 group-hover:translate-x-1 group-hover:text-white" />
              </button>
            </Link>
            ...
            <Link href="/solutions" className="w-full sm:w-auto">
              <button 
                type="button"
                className="w-full sm:w-auto h-11 px-6 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-800 text-sm font-semibold border border-slate-200 transition-colors flex items-center justify-center"
              >
                Explore Modules
              </button>
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-14 border-b border-slate-200">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between space-y-6">
            <div>
              ...
              <div className="mt-5 flex flex-wrap items-center gap-2 text-[11px] font-semibold text-slate-600">
