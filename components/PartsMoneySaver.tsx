...
export function PartsMoneySaver() {
  return (
    <div className="bg-[#fff5f5] rounded-3xl md:rounded-[3rem] p-3 md:p-6 w-full border border-rose-100 font-sans text-gray-900">
      <div className="bg-white/80 backdrop-blur-xl rounded-2xl md:rounded-[2.5rem] flex flex-col border border-white">
        ...
        <div className="px-4 md:px-10 py-4 md:py-8 border-b border-rose-50 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
           ...
           <div className="hidden lg:flex gap-4 shrink-0">
              <div className="bg-white rounded-xl px-4 py-2 flex items-center gap-3 border border-gray-100 w-full">
        ...
        <div className="p-4 md:p-10 flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div className="bg-white p-6 rounded-[2rem] border border-rose-100 relative overflow-hidden group">
            ...
            <div className="bg-white p-6 rounded-[2rem] border border-gray-100 flex flex-col justify-between">
               ...
               <button className="mt-4 flex items-center justify-center gap-2 bg-amber-500 text-white px-4 py-3 rounded-xl text-xs font-bold hover:bg-amber-600 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-3xl md:rounded-[2.5rem] border border-gray-100 p-6 md:p-8 flex flex-col sm:flex-row items-center gap-6 md:gap-8 relative overflow-hidden">
               <div className="shrink-0 w-32 aspect-[9/19] bg-gray-950 rounded-3xl border-4 border-gray-900 overflow-hidden flex flex-col relative">
                  <div className="absolute inset-0 bg-emerald-500/10 animate-pulse"></div>
                  <div className="flex-1 flex items-center justify-center">
                     <QrCode className="w-12 h-12 text-white" />
                  </div>
                  <div className="absolute left-0 right-0 h-0.5 bg-emerald-400 top-1/2 -translate-y-1/2"></div>
               </div>
               <div>
            ...
            <div className="bg-gray-900 rounded-[2.5rem] border border-gray-800 p-8 relative overflow-hidden text-white flex flex-col justify-center">
               ...
               <div className="grid grid-cols-6 gap-2 w-full max-w-xs relative z-10">
                 {Array.from({ length: 18 }).map((_, i) => (
                   <div 
                     key={i} 
                     className={`aspect-square rounded-lg flex items-center justify-center ${i === 8 ? 'bg-rose-500  border-rose-400' : 'bg-gray-800 border-gray-700'} border`}
                   >
